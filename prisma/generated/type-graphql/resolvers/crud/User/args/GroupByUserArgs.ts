...
export class GroupByUserArgs {
  ...
  by!: Array<"id" | "name" | "email" | "mobileNumber" | "dateOfBirth" | "password" | "isEmailVerified" | "verificationCode" | "resetToken" | "resetTokenExpiry" | "profilePicture" | "createdAt" | "updatedAt">;
